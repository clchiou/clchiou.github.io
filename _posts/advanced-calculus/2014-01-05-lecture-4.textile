...
<li>$a_n \leq \alpha, \beta \leq b_n \Rightarrow 0 \leq \beta - \alpha \leq b_n - a_n \rightarrow 0$</li>
...
<li>Consider two cases:
  ...
  <li>There are infinitely many values in $\{ x_n \}$
    ...
    <li><notextile>$|I_n| = b_n - a_n = \frac{b_{n-1} - a_{n-1}}{2} = \cdots = \frac{b-a}{2^n} \rightarrow 0$</notextile></li>
    ...
    <li>Pick any $x_{n_k} \in I_k, a_k \leq x_{n_k} \leq b_k \Rightarrow \lim_{k\rightarrow\infty} x_{n_k} = x_0$</li>
    </ul>
  </li>
  </ol>
</li>
