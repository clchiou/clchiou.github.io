...
_Proof._
Suppose ${\small\#}S = {\small\#}[0, 1].$  There is a 1-to-1, onto function $\phi(t) = f_t$ for all $t \in [0, 1].$  Let $g(x) = \Big(\phi(x)\Big)(x) + 1 = f_x(x) + 1.$  Since $g \in S,$ let $a \in [0, 1]$ denote $\phi(a) = g.$  Then $g(a) - 1 = \Big(\phi(a)\Big)(a) - 1 = g(a)$ constitutes a contradiction.
